...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Documentos en Capítulo III</title><!--Título de la Página-->
...
<br>
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/documentos_fase_3.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Documentos'></span></a>
				<?php }?>
				...
				<a href="documentos.php"><span class="icon-checkmark" title='Lista de Documentos'></span></a>
				...
				<div class="titulo_sencillo"><p>Documentos en Capítulo III.</p></div>
				
			<?php 
				include("../../controlador/php/documentos_fase_3.php");
			?>
