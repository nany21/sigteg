...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Trabajos Especiales de Grado Aprobados</title><!--Título de la Página-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/trabajos.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Trabajos'></span></a>
				<?php }?>
				...
				<div class="titulo_sencillo"><p>Trabajos Especiales de Grado Aprobados.</p></div>
				
			<?php 
				include("../../controlador/php/trabajos_aprobado.php");
			?>
