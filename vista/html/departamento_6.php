		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="titulo_sencillo"><p>Departamento de Mercadeo.</p></div>
				...
				<section>
					...
					<hr>
					<br><br>
					<p class='p_text'>•	Fortalecer los procesos de enseñanza aprendizaje en la formación integral de los 
						estudiantes de en el área de Distribución y Logística, Mercadeo, Publicidad y Comercio Exterior 
						en cumplimiento con las políticas establecidas por la institución.
					</p>
					<br><br>
					<p class='p_text'>•	Ejercer eficientemente la planificación, organización, ejecución y control de 
						las actividades académicas y administrativas.
					</p>
					<br><br>
					<p class='p_text'>•	Optimizar la administración y supervisión del talento humano y los recursos 
						materiales que le sean asignados para su funcionamiento.
					</p>
					<br><br>

				</section>
<div id="fecha"	<div id="fecha" style="margin-top:-310px; margin-left:760px;color:#797979;float:left;">	
		<script>
			var f = new Date();
