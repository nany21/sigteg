...
<!--Módulo de Visualizar Usuarios-->
	...
	<head><!--Cabecera-->
		...
		<title>Visualizar Usuarios</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<a href="usuario_bloqueado.php"><span class="icon-lock-rounded2" title='Mostrar Usuarios Desactivados'></span></a>
			...
			<?php 
				include("../../controlador/php/usuario_visualizar.php");
			?>
