...
<!--Módulo de Registrar Trabajos-->
	...
	<head><!--Cabecera-->
		...
		<title>Registrar Trabajos</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="form_reg_doc" style="margin-top:20px; height:590px; width:760px;">
				<label><p class="titulo2" style="width:760px;">Registro de Trabajo Especial de Grado<a href="trabajos.php"><span class="icon-cancel-circle"></span></a></p></label>
				<div style=" height:94%; width:100%;overflow-y:auto;overflow-x:hidden;">
					<form action="../../controlador/php/trabajos_registrar.php" method="POST">
