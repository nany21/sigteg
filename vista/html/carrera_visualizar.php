...
<!--Módulo de Visualizar Carrera-->
	...
	<head><!--Cabecera-->
		...
		<title>Visualizar Carrera</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<?php 
				include("../../controlador/php/carrera_visualizar.php");
			?>

		</div><!--Cierre de la división del #id="general"-->
	</body><!--Cierre del Cuerpo del Documento-->
</html><!--Cierre del Documento HTML-->Carrera