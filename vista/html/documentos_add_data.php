	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<a href="documentos_buscar.php"><span class="icon-magnifier" title="Buscar Trabajo"></span></a>
				<a href="documentos_fase_1.php"><span class="icon-filter_1" title='Lista de Trabajos Fase 1'></span></a>
				<a href="documentos_fase_2.php"><span class="icon-filter_2" title='Lista de Trabajos Fase 2'></span></a>
				<a href="documentos_fase_3.php"><span class="icon-filter_3" title='Lista de Trabajos Fase 3'></span></a>
				<a href="documentos_fase_4.php"><span class="icon-filter_4" title='Lista de Trabajos Fase 4'></span></a>
				<a href="documentos_fase_5.php"><span class="icon-filter_5" title='Lista de Trabajos Fase 5'></span></a>
				<a href="documentos.php"><span class="icon-checkmark" title='Lista de Trabajos Aprobados'></span></a>
				<a href="documentos_reprobado.php"><span class="icon-cancel2" title='Lista de Trabajos Reprobados'></span></a>
				<a href="documentos_suspendido.php"><span class="icon-cancel" title='Lista de Trabajos Suspendidos'></span></a>

			</div>

			<div class="form_reg_doc" style="margin-top:20px; height:300px; width:660px;">
				<form action="../../controlador/php/documentos_add_data.php" method="POST">
					<table class="table2" style="width:700px;" border="0">
						
						<tr>
							<label><p class="titulo2" style="width:660px;">Añadir Localización a Documento<a href="documentos.php"><span class="icon-cancel-circle"></span></a></p></label>
						</tr>
						...
						<tr>
							<td class="td_titulo3">
								<label for="archivo"><p class="p_left"><span class="icon-file-pdf" style="margin-left:10px;"></span> Documento en PDF:</p></label>
							</td>
							<td class="td_caja_3">
						...
						<tr>
							<td class="td_titulo3">
								<label><p class="p_left" style="width:300px;"><span class="icon-layers"></span>Título del Documento:</p></label>
							</td>
							<td class="td_caja_3"> 
