...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Documentos en Capítulo I</title><!--Título de la Página-->
...
<br>
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/documentos_fase_1.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Documentos'></span></a>
				<?php }?>
				...
				<div class="titulo_sencillo"><p>Documentos en Capítulo I.</p></div>
				
			<?php 
				include("../../controlador/php/documentos_fase_1.php");
			?>
