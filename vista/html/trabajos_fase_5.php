...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Trabajos Especiales de Grado en Capítulo V</title><!--Título de la Página-->
...
<br>
			<div class="iconos_principales">
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/trabajos_fase_5.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Trabajos'></span></a>
				<?php }?>
				...
				<div class="titulo_sencillo"><p>Trabajos Especiales de Grado en Capítulo V.</p></div>
				
			<?php 
				include("../../controlador/php/trabajos_fase_5.php");
			?>
