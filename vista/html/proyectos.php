...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Proyectos Socio - Integradores Aprobados</title><!--Título de la Página-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/proyectos.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Proyectos'></span></a>
				<?php }?>
				...
				<div class="titulo_sencillo"><p>Proyectos Socio - Integradores Aprobados.</p></div>
				
			<?php 
				include("../../controlador/php/proyectos_aprobado.php");
			?>
