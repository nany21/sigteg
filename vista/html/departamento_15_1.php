		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="titulo_sencillo"><p>Departamento de Mercadeo.</p></div>
				...
				<section>
					...
					<hr>
					<br><br>
					<p class='p_text'>10.	Comité de Post Grado.
					</p>
					<br><br>
					<p class='p_text'>11.	Comité de Servicio Comunitario y Acreditación.
					</p>
					<br><br>
					<p class='p_text'>12.	Comité de Extensión, Cultura y Producción.
					</p>
					<br><br>
					<p class='p_text'>13.	Comité de Pasantías.
					</p>
					<br><br>
					<p class='p_text'>14.	Comité de Municipalización.
					</p>
					<br><br>
					
				</section>
<div id="fecha"	<div id="fecha" style="margin-top:-300px; margin-left:760px;color:#797979;float:left;">	
		<script>
			var f = new Date();
