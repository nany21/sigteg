...
<!--Módulo de Acerca de-->
	...
	<head><!--Cabecera-->
		...
		<title>Definición.</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="titulo_sencillo"><p>Departamento de Mercadeo.</p></div>
				...
				<section>
					<h2 class='h2'>Definición</h2>
					<hr>
					<br><br>
					<p class='p_text'>El Departamento de Mercadeo es una dependencia académica que promueve, organiza, 
						articula e integra la participación de los diversos entes que lo conforman con el propósito de 
						planificar, ejecutar, coordinar, controlar, evaluar las actividades académicas y administrativas 
						que sirven de apoyo significativo a la gestión institucional en respuesta a las necesidades, 
						potencialidades y aspiraciones de la Universidad Politécnica Territorial de Paria. “Luis Mariano 
						Rivera”, en la construcción del nuevo modelo de sociedad.
						</p>
					<br><br>
