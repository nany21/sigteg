		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="titulo_sencillo"><p>Departamento de Mercadeo.</p></div>
				...
				<section>
					...
					<hr>
					<br><br>
					<p class='p_text'>Dentro del sistema de carreras cortas tecnológicas aún subsisten: Construcción Naval 
						y Mercadeo, con las menciones de Mercadeo, Publicidad y Comercio Exterior, estando esta última 
						carrera ya mencionada vinculada directamente con el Departamento de Mercadeo, debido a que fue unos 
						de los primeros programas implementados desde los años ochenta, la cual ofrece a los bachilleres de 
						nuevos ingresos al cursar este plan de estudios la oportunidad de convertirse en Técnico Superior bajo 
						la mención de Mercadeo, Comercio Exterior y Publicidad, y con una de las tres menciones ya señaladas 
						podrá continuar la Licenciatura al cursar el pensum de Distribución y Logística.
					</p>
					<br><br>
					
				</section>
<div id="fecha" style="margin-top:-265px; margin-left:760px;color:#797979;float:left;">	
		<script>
			var f = new Date();
