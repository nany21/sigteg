<!DOCTYPE HTML>
<html>
<!--Módulo de Carreras Desactivadas-->
	...
	<head><!--Cabecera-->
		...
		<title>Carreras Desactivadas</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<a href="../../controlador/PDF/examples/carrera_bloqueada.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Carreras'></span></a>
				<a href="carrera.php"><span class='icon-lock-rounded-open2' title="Lista de Carreras Activas"></span></a>

			</div>

				<div class="titulo_sencillo"><p>Carreras Desactivadas.</p></div>
			
			<?php 
				include("../../controlador/php/carrera_mostrar_blo.php");
			?>
