...
<!--Módulo de Acerca de-->
	...
	<head><!--Cabecera-->
		...
		<title>Estructura.</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="titulo_sencillo"><p>Departamento de Mercadeo.</p></div>
				...
				<section>
					<h2 class='h2'>Estructura.</h2>
					<hr>
					<br><br>
					<p class='p_text'>El Departamento de Mercadeo es una dependencia universitaria integra en los procesos 
						de formación académica y en el aprovechamiento óptimo de sus recursos y potencialidades a los fines 
						de configurar una vigorosa gestión académico-administrativa consolidada y sustentada en los valores 
						éticos y políticos de la educación emancipadora al servicio de las comunidades para promover y 
						ejecutar proyectos económicos y sociales orientados hacia el desarrollo integral y sustentable que 
						trasciendan el modelo capitalista al modelo económico productivo socialista.
					</p>
					<br><br>
					
				</section>
<div id="fecha"	<div id="fecha" style="margin-top:-240px; margin-left:760px;color:#797979;float:left;">	
		<script>
			var f = new Date();
