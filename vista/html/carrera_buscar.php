		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="form_bus" style="margin-top:20px;">
				<table class="table2" border="0">
					<th>
						<tr>
							<label><p class="titulo3">Buscar Carrera<a href="carrera.php"><span class="icon-cancel-circle"></span></a></p></label>
						</tr>
						<tr>
							<form action="../../controlador/php/carrera_buscar.php" method="POST">
							<td class="td_titulo_2">
								<label><p class="p_right"><span class="icon-search"></span>Buscar:</p></label>
							</td>
							<td class="td_caja_2">
								<input type="text" name="codigo_carrera" class="input3 placeholder2" placeholder="Ingrese código" maxlength="8" required autofocus autocomplete="off" onKeyPress="return SoloNumeros(event);"><br>
							</td>
						</tr>
				</table>	
