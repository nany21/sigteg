...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Proyectos Socio - Integradores Suspendidos</title><!--Título de la Página-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/proyectos_suspendido.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Proyectos'></span></a>
				<?php }?>
				...
				<div class="titulo_sencillo"><p>Proyectos Socio - Integradores Suspendidos.</p></div>
				
			<?php 
				include("../../controlador/php/proyectos_suspendido.php");
			?>
