...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Trabajos Especiales de Grado Aprobar</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<a href="documentos_buscar.php"><span class="icon-magnifier" title='Buscar Documentos'></span></a>
			...
			<?php 
				include("../../controlador/php/documentos_aprobar.php");
			?>
