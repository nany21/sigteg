	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="form_reg_doc" style="margin-top:20px; height:300px; width:660px;">
				<form action="../../controlador/php/proyectos_add_data.php" method="POST">
					<table class="table2" style="width:700px;" border="0">
						
						<tr>
							<label><p class="titulo2" style="width:660px;">Añadir Localización a Proyecto Socio - Integrador<a href="proyectos.php"><span class="icon-cancel-circle"></span></a></p></label>
						</tr>
						...
						<tr>
							<td class="td_titulo3">
								<label for="archivo"><p class="p_left"><span class="icon-file-pdf" style="margin-left:10px;"></span> Proyecto en PDF:</p></label>
							</td>
							<td class="td_caja_3">
						...
						<tr>
							<td class="td_titulo3">
								<label><p class="p_left"><span class="icon-layers"></span>Título del Proyecto:</p></label>
							</td>
							<td class="td_caja_3"> 
								<select class="input5" name="id_asignacion" required>
									...
									<?php
										...
										$sql="SELECT id_asignacion, titulo_asignacion FROM asignacion WHERE status_asignacion='Aprobado' AND tipo_asignacion='proyecto'";
