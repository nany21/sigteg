...
<!--Módulo de Usuarios-->
	...
	<head><!--Cabecera-->
		...
		<title>Usuarios</title><!--Título de la Página-->
		...
		<link rel="stylesheet" type="text/css" href="../../vista/css/iconos_fuentes.css">
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<a href="../../controlador/PDF/examples/usuario.php" target='_blank'><span class="icon-printer-text2" title='Imprimir Usuarios'></span></a>
				<a href="usuario_bloqueado.php"><span class="icon-lock-rounded2" title='Mostrar Usuarios Bloqueados'></span></a>
				
			</div>

				<div class="titulo_sencillo"><p>Usuarios Activos.</p></div>
				
			<?php 
				include("../../controlador/php/usuario_mostrar.php");
			?>
