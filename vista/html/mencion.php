...
<!--Módulo de Menciones-->
	...
	<head><!--Cabecera-->
		...
		<title>Menciones</title><!--Título de la Página-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/mencion.php" target='_blank'><span class="icon-printer-text2" title='Imprimir Lista de Menciones'></span></a>
				...
				<div class="titulo_sencillo"><p>Menciones.</p></div>
				
			<?php 
				include("../../controlador/php/mencion_mostrar.php");
			?>
