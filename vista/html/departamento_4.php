		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="titulo_sencillo"><p>Departamento de Mercadeo.</p></div>
				...
				<section>
					...
					<hr>
					<br><br>
					<p class='p_text'>Convertir el Departamento de Mercadeo en una dependencia académica integra en los 
						procesos de formación profesional, actividades de docencia, investigación, extensión, producción, 
						y en el aprovechamiento óptimo de sus recursos y potencialidades a los fines de configurar una 
						vigorosa gestión académica y administrativa consolidada y sustentada en los valores éticos y 
						humanista de la educación emancipadora promoviendo proyectos socio productivos al servicio de las 
						comunidades.
					</p>
					<br><br>
