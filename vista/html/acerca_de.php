...
<!--Módulo de Acerca de-->
	...
	<head><!--Cabecera-->
		...
		<title>Acerca de</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="titulo_sencillo"><p>Acerca de</p></div>
			

				<ul class="p_mostrar" style="height:200px;">
					<br>
					<a href="sgteg.php"><p class="p_fila">- Sistema de Gestión de Trabajos Especiales de Grado.</p></a>
					<a href="uptp.php"><p class="p_fila">- Universidad Politécnica Territorial de Paria. "Luis Mariano Rivera".</p></a>
					<a href="departamento.php"><p class="p_fila">- Departamento de Mercadeo.</p></a>
					<a href="trabajos_de_grado.php"><p class="p_fila">- Trabajos Especiales de Grado.</p></a>
					<br>
				</ul>
<div id="fecha"	<div id="fecha" style="margin-top:-287px; margin-left:760px;color:#797979;float:left;">	
		<script>
			var f = new Date();
