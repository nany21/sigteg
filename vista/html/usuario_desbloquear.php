...
<!--Módulo de Activar Usuarios-->
	...
	<head><!--Cabecera-->
		...
		<title>Activar Usuarios</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<a href="#"><span class="icon-printer-text2" title='Imprimir Usuarios'></span></a>
				<a href="usuario.php"><span class='icon-lock-rounded-open2' title='Mostrar Usuarios Activos'></span></a>

			</div>
				
			<?php 
				include("../../controlador/php/usuario_desbloquear.php");
			?>
