		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="form_bus4">
				<table class="table2" border="0">
					<th>
						<tr>
							<label><p class="titulo7">Buscar Trabajos Especiales de Grado.<a href="trabajos.php"><span class="icon-cancel-circle"></span></a></p></label>
						</tr>
						<tr>
							<form action="../../controlador/php/trabajos_buscar.php" method="POST">
