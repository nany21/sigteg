...
<!--Módulo de Acerca de-->
	...
	<head><!--Cabecera-->
		...
		<title>Universidad Politécnica Territorial de Paria. "Luis Mariano Rivera".</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="titulo_sencillo"><p>Universidad Politécnica Territorial de Paria. "Luis Mariano Rivera".</p></div>
				...
				<ul class="p_mostrar">
					<br>
					<a href="localizacion.php"><p class="p_fila">1) Localización.</p></a>
					<a href="historia.php"><p class="p_fila">2) Reseña Histórica.</p></a>
					<a href="mision.php"><p class="p_fila">3) Misión.</p></a>
					<a href="vision.php"><p class="p_fila">4) Visión.</p></a>
					<a href="organigrama.php"><p class="p_fila">5) Organigrama.</p></a>
					<a href="objetivos.php"><p class="p_fila">6) Objetivos.</p></a>
					<br>
				</ul>
<div id="fecha"	<div id="fecha" style="margin-top:-387px; margin-left:760px;color:#797979;float:left;">	
		<script>
			var f = new Date();
