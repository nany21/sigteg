...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Documentos Suspendidos</title><!--Título de la Página-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/documentos_suspendido.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Documentos'></span></a>
				<?php }?>
				...
				<div class="titulo_sencillo"><p>Documentos Suspendidos.</p></div>
				
			<?php 
				include("../../controlador/php/documentos_suspendido.php");
			?>
