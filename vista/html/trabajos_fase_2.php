...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Trabajos Especiales de Grado en Capítulo II</title><!--Título de la Página-->
...
<br>
			<div class="iconos_principales">
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/trabajos_fase_2.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Trabajos'></span></a>
				<?php }?>
				...
				<div class="titulo_sencillo"><p>Trabajos Especiales de Grado en Capítulo II.</p></div>
				
			<?php 
				include("../../controlador/php/trabajos_fase_2.php");
			?>
