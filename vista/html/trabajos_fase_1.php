...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Trabajos Especiales de Grado en Capítulo I</title><!--Título de la Página-->
...
<br>
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/trabajos_fase_1.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Trabajos'></span></a>
				<?php }?>
				...
				<div class="titulo_sencillo"><p>Trabajos Especiales de Grado en Capítulo I.</p></div>
				
			<?php 
				include("../../controlador/php/trabajos_fase_1.php");
			?>
