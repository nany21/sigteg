...
<!--Módulo de Docente-->
	...
	<head><!--Cabecera-->
		...
		<title>Proyectos Socio - Integradores Reprobados</title><!--Título de la Página-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<?php 
					...
					{?>
						<a href="../../controlador/PDF/examples/proyectos_reprobado.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Proyectos'></span></a>
				<?php }?>
				...
				<div class="titulo_sencillo"><p>Proyectos Socio - Integradores Reprobados.</p></div>
				
			<?php 
				include("../../controlador/php/proyectos_reprobado.php");
			?>
