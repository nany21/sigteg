<!DOCTYPE HTML>
<html>
<!--Módulo de Instituciones Desactivadas-->
	...
	<head><!--Cabecera-->
		...
		<title>Instituciones Desactivadas</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<a href="../../controlador/PDF/examples/comunidad_bloqueada.php" target='_blank'><span class="icon-printer-text2" title='Imprimir lista de Instituciones'></span></a>
				<a href="comunidad.php"><span class='icon-lock-rounded-open2' title="Lista de Instituciones Activas"></span></a>

			</div>

				<div class="titulo_sencillo"><p>Instituciones Desactivadas.</p></div>
			
			<?php 
				include("../../controlador/php/comunidad_mostrar_blo.php");
			?>
