<!DOCTYPE HTML>
<html>
<!--Módulo de Docentes Desactivados-->
	...
	<head><!--Cabecera-->
		...
		<title>Docentes Desactivados</title><!--Título de la Página-->
	...
	<body><!--Cuerpo del Documento-->
		...
		página del sistema, sus atribulos se visualizan en el archivo vista/css/estilos.css-->
			...
			<div class="iconos_principales">
				...
				<a href="../../controlador/PDF/examples/docente_bloqueado.php" target='_blank'><span class="icon-printer-text2" title="Imprimir Lista de Docentes"></span></a>
				<a href="docente.php"><span class='icon-lock-rounded-open2' title="Lista de Docentes Activos"></span></a>

			</div>

				<div class="titulo_sencillo"><p>Docentes Desactivados</p></div>
			
			<?php 
				include("../../controlador/php/docente_mostrar_blo.php");
			?>
