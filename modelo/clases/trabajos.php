	...
	public function buscar()
		{
			...
			$this->sql="SELECT * FROM asignacion WHERE cod_asignacion='$this->cod_asignacion' AND tipo_asignacion='trabajo';";
			$this->ejecutar=pg_query($this->sql);

			$this->cantidad=pg_num_rows($this->ejecutar);
			if($this->cantidad<1)
			{
				echo"<script>alert('Trabajo no encontrado / Dato Incorrecto')</script>
				<meta http-equiv='refresh' content='0;../../vista/html/trabajos.php'>";
			}
			else
			{
					...
					while ($this->datos=pg_fetch_array($this->ejecutar))
					{
						...
						<tr class='table_fila'>
							...
							<td>";
								...
								{
									echo"
										<a href='../../vista/html/trabajos_visualizar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-eye' title='Visualizar Trabajo'></span></a>
										<a href='../../vista/html/trabajos_add_data.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-redo2' title='Añadir datos'></span></a>";
								}
								else
								{
									if($this->datos['status_asignacion']=="Fase I")
										echo"<a href='../../vista/html/trabajos_visualizar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-eye' title='Visualizar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_modificar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-pencil' title='Modificar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_fase2.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-looks_two' title='Cambiar a Capítulo II'></span></a>
											<a href='../../vista/html/trabajos_reprobar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-cross' title='Reprobar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_suspender.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-blocked' title='Suspender Trabajo'></span></a>";
									else
									if($this->datos['status_asignacion']=="Fase II")
										echo"<a href='../../vista/html/trabajos_visualizar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-eye' title='Visualizar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_modificar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-pencil' title='Modificar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_fase3.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-looks_3' title='Cambiar a Capítulo III'></span></a>
											<a href='../../vista/html/trabajos_reprobar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-cross' title='Reprobar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_suspender.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-blocked' title='Suspender Trabajo'></span></a>";
									else
									if($this->datos['status_asignacion']=="Fase III")
										echo"<a href='../../vista/html/trabajos_visualizar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-eye' title='Visualizar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_modificar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-pencil' title='Modificar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_fase4.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-looks_4' title='Cambiar a Capítulo IV'></span></a>
											<a href='../../vista/html/trabajos_reprobar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-cross' title='Reprobar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_suspender.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-blocked' title='Suspender Trabajo'></span></a>";
									else
									if($this->datos['status_asignacion']=="Fase IV")
										echo"<a href='../../vista/html/trabajos_visualizar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-eye' title='Visualizar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_modificar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-pencil' title='Modificar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_fase5.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-looks_5' title='Cambiar a Capítulo V'></span></a>
											<a href='../../vista/html/trabajos_reprobar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-cross' title='Reprobar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_suspender.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-blocked' title='Suspender Trabajo'></span></a>";
									else
									if($this->datos['status_asignacion']=="Fase V")
										echo"<a href='../../vista/html/trabajos_visualizar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-eye' title='Visualizar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_modificar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-pencil' title='Modificar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_aprobar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-checkmark2' title='Aprobar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_reprobar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-cross' title='Reprobar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_suspender.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-blocked' title='Suspender Trabajo'></span></a>";
									else
									if($this->datos['status_asignacion']=="Suspendido")
										echo"<a href='../../vista/html/trabajos_visualizar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-eye' title='Visualizar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_modificar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-pencil' title='Modificar Trabajo'></span></a>
											<a href='../../vista/html/trabajos_fase1.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-looks_one' title='Cambiar a Capítulo I'></span></a>
											<a href='../../vista/html/trabajos_reprobar.php?codigo=".$this->datos['cod_asignacion']."'><span class='icon-cross' title='Reprobar Trabajo'></span></a>";
									else
		...
		public function modificar($codigo_oculto,$ced_ocul,$au_total)
		{
			...
			else
			{
				...
				if($this->cantidad>0)
				{
					echo"<script>alert('Trabajo ya registrado. Verifique los datos.')</script>
					<meta http-equiv='refresh' content='0;../../vista/html/trabajos_modificar.php?codigo=$codigo_oculto'>";
				}
				else
				{
					$this->sql="";
					...
					if($this->ejecutar)
					{
						echo"<script>alert('Trabajo Modificado exitosamente')</script> 
						<meta http-equiv='refresh' content='0;../../vista/html/trabajos.php'>";
					}
					else
					{
		...
		public function modificar_form()
		{
			...
			$this->sql="SELECT * FROM asignacion,categoria,institucion,facilitador,especialista WHERE cod_categoria=id_categoria AND codigo_institucion=id_institucion AND codigo_asignacion=id_asignacion AND cod_facilitador=id_facilitador AND tipo_asignacion='trabajo' AND cod_asignacion='$this->cod_asignacion'";
			$this->ejecutar=pg_query($this->sql);

			$this->cantidad=pg_num_rows($this->ejecutar);
			if($this->cantidad<1)
			{
				echo"<script>alert('Trabajo no Registrado')</script>
				<meta http-equiv='refresh' content='0;../../vista/html/trabajos.php'>";
			}
			else
			{
				...
				<label><p class="titulo2" style="width:710px;">Modificar Trabajo<a href="trabajos.php"><span class="icon-cancel-circle"></span></a></p></label>
				<div style=" height:94%; width:100%;overflow-y:auto;overflow-x:hidden;">
					<form action="../../controlador/php/trabajos_modificar.php" method="POST">

						<div class="tr">
							<label for="titulo"><p class="p_left"><span class="icon-spell-check"></span> Título del Trabajo:</p></label>
							<div class="td">
						...
						<div class="tr" style="margin-top:-5px;">
							<label for="codigo"><p class="p_left"><span class="icon-sort-numerically-outline"></span> Código de Trabajo:</p></label>
							<div class="td">
		...
		public function mostrar($mos)
		{
			...
			$fecha=date("d/m/Y");
			if($mos==0)
				$this->sql="SELECT * FROM asignacion WHERE tipo_asignacion='trabajo' AND status_asignacion='Reprobado' ORDER BY titulo_asignacion ASC;";
			else
				if($mos==1)
				$this->sql="SELECT * FROM asignacion WHERE tipo_asignacion='trabajo' AND status_asignacion='Fase I' ORDER BY titulo_asignacion ASC;";
			else
				if($mos==2)
				$this->sql="SELECT * FROM asignacion WHERE tipo_asignacion='trabajo' AND status_asignacion='Fase II' ORDER BY titulo_asignacion ASC;";
			else
				if($mos==3)
				$this->sql="SELECT * FROM asignacion WHERE tipo_asignacion='trabajo' AND status_asignacion='Fase III' ORDER BY titulo_asignacion ASC;";
			else
				if($mos==4)
				$this->sql="SELECT * FROM asignacion WHERE tipo_asignacion='trabajo' AND status_asignacion='Fase IV' ORDER BY titulo_asignacion ASC;";
			else
				if($mos==5)
				$this->sql="SELECT * FROM asignacion WHERE tipo_asignacion='trabajo' AND status_asignacion='Aprobado' ORDER BY titulo_asignacion ASC;";
			else
				if($mos==6)
				$this->sql="SELECT * FROM asignacion WHERE tipo_asignacion='trabajo' AND status_asignacion='Suspendido' ORDER BY titulo_asignacion ASC;";
			else
				if($mos==7)
				$this->sql="SELECT * FROM asignacion WHERE tipo_asignacion='trabajo' AND status_asignacion='Fase V' ORDER BY titulo_asignacion ASC;";
			$this->ejecutar=pg_query($this->sql);
		...
		public function registrar()
		{
			...
			{
				echo"<script>alert('Error en la Consulta')</script>
				<meta http-equiv='refresh' content='0;../../vista/html/trabajos_registrar.php'>";
			}
			else
			{
				$this->cantidad=pg_fetch_array($this->ejecutar);
				...
				{
					$this->sql="INSERT INTO asignacion (id_asignacion,titulo_asignacion,status_asignacion,tipo_asignacion,cod_asignacion,mes,ano,cod_categoria,codigo_institucion) VALUES (default,'$this->titulo_asignacion','Fase I','trabajo','$this->cod_asignacion','$this->mes','$this->ano',$this->id_categoria,$this->id_institucion);
		...
		public function visualizar()
		{
			...
			$this->sql="SELECT * FROM asignacion,categoria,institucion,facilitador,especialista WHERE cod_categoria=id_categoria AND codigo_institucion=id_institucion AND codigo_asignacion=id_asignacion AND cod_facilitador=id_facilitador AND cod_asignacion='$this->cod_asignacion' AND tipo_asignacion='trabajo'";
			$this->ejecutar=pg_query($this->sql);
			...
			else
			{
				...
				<label><p class="titulo2" style="width:690px;">Visualizar Trabajo Especial de Grado<a href="trabajos.php"><span class="icon-cancel-circle"></span></a></p></label>
				<div style=" height:94%; width:100%;overflow-y:auto;overflow-x:hidden;">
					<style>
