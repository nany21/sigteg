<?php
	...
	public function add_data()
		{
			$this->sql="SELECT * FROM asignacion,localizacion WHERE id_asignacion=cod_trabajo AND tipo_asignacion='documento'";
			$this->ejecutar=pg_query($this->sql);

			if(!$this->ejecutar)
			{
				echo"<script>alert('Error en la Consulta')</script>
				<meta http-equiv='refresh' content='0;../../vista/html/documentos_add_data.php'>";
			}
			else
			{
