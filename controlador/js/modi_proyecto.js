$(document).ready(function(){
	...
	$("#input-plus").click(function(){
		if(cantidad < 12){
			...
			$('#mas').append('</div><div class="td_2 parti'+cantidad+'"><label><p style="color:#fff; margin-top:px;">(*)</p></label></div></div>');	
			...
			$('#mas').append('</div><div class="td_2 parti'+cantidad+'"><label><p style="color:#fff;">(*)</p></label></div></div>');			
