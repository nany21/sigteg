...
<?php
	...
	$sql="SELECT * FROM mencion,carrera WHERE cod_carrera=id_carrera AND cod_mencion=cod_mencion";
		...
		<page backleft="10mm" backtop="20mm" backright="10mm" backbottom="10mm" footer="page;heure;date">
			<div class="tabla">
				<page_header >
					...
					<h4 class="titulo" id="titu">DATOS DE MENCIÓN.</h4>
				</page_header>';
				$select= pg_query("SELECT * FROM mencion,carrera WHERE cod_carrera=id_carrera AND cod_mencion=cod_mencion LIMIT '1' ");
