...
<?php
	...
	$sql="SELECT * FROM asignacion,categoria WHERE id_categoria=cod_categoria AND tipo_asignacion='documento' AND status_asignacion='Fase II' ";
		...
		<page backleft="10mm" backtop="20mm" backright="10mm" backbottom="10mm" footer="page;heure;date">
			<div class="tabla">
				<page_header >
					...
					<h4 class="titulo" id="titu">LISTA DE DOCUMENTOS EN CAPÍTULO II.</h4>
				</page_header>';
				$select= pg_query("SELECT * FROM asignacion,categoria WHERE id_categoria=cod_categoria AND tipo_asignacion='documento' AND status_asignacion='Fase II' ORDER BY titulo_asignacion ASC LIMIT $lim OFFSET $off  ");
