...
<?php
	...
	$sql="SELECT * FROM asignacion,categoria WHERE id_categoria=cod_categoria AND tipo_asignacion='proyecto' AND status_asignacion='Fase IV' ";
		...
		<page backleft="10mm" backtop="20mm" backright="10mm" backbottom="10mm" footer="page;heure;date">
			<div class="tabla">
				<page_header >
					...
					<h4 class="titulo" id="titu">LISTA DE PROYECTOS SOCIO - INTEGRADORES EN FASE IV.</h4>
				</page_header>';
				$select= pg_query("SELECT * FROM asignacion,categoria WHERE id_categoria=cod_categoria AND tipo_asignacion='proyecto' AND status_asignacion='Fase IV' ORDER BY titulo_asignacion ASC LIMIT $lim OFFSET $off  ");
