		...
		<page backleft="10mm" backtop="20mm" backright="10mm" backbottom="10mm" footer="page;heure;date">
			<div class="tabla">
				<page_header >
					...
					<h4 class="titulo" id="titu">LISTA DE EMPRESAS O INSTITUCIONES.</h4>
				</page_header>';
				$select= pg_query("SELECT * FROM institucion WHERE tipo_institucion='Empresa' ORDER BY nombre_institucion ASC LIMIT $lim OFFSET $off  ");
