...
<?php
	...
	$sql="SELECT * FROM personal,usuario WHERE cod_personal=id_personal AND status!='Activo' AND id_personal!='1' ";
		...
		<page backleft="10mm" backtop="20mm" backright="10mm" backbottom="10mm" footer="page;heure;date">
			<div class="tabla">
				<page_header >
					...
					<h4 class="titulo" id="titu">LISTA DE USUARIOS DESACTIVADOS.</h4>
				</page_header>';
				$select= pg_query("SELECT * FROM personal,usuario WHERE cod_personal=id_personal AND status!='Activo' AND id_personal!='1' ORDER BY nombre_per ASC LIMIT $lim OFFSET $off  ");
