		...
		<page backleft="10mm" backtop="20mm" backright="10mm" backbottom="10mm" footer="page;heure;date">
			<div class="tabla">
				<page_header >
					...
					<h4 class="titulo" id="titu">LISTA DE CARRERAS DESACTIVADAS.</h4>
				</page_header>';
				$select= pg_query("SELECT * FROM carrera WHERE status_carrera!='Activo' ORDER BY nombre_carrera ASC LIMIT $lim OFFSET $off  ");
				$mostrar=pg_num_rows($select);
				$off=$lim+$off;
				
				echo"<table border='1' style='margin-top:70px;margin-left:30px;'>
					<tr >
