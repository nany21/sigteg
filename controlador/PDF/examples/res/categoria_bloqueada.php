...
<?php
	...
	$sql="SELECT * FROM categoria,mencion WHERE codigo_mencion=id_mencion AND status_categoria!='Activo' ";
		...
		<page backleft="10mm" backtop="20mm" backright="10mm" backbottom="10mm" footer="page;heure;date">
			<div class="tabla">
				<page_header >
					...
					<h4 class="titulo" id="titu">LISTA DE CATEGORÍAS DESACTIVADAS.</h4>
				</page_header>';
				$select= pg_query("SELECT * FROM categoria,mencion WHERE codigo_mencion=id_mencion AND status_categoria!='Activo' ORDER BY nombre_categoria ASC LIMIT $lim OFFSET $off  ");
